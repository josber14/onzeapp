  ...
  try {
    ...
    return NextResponse.json({
      ...
      operations: operations.map((op) => ({
        ...
        operatorProfitFinalAmount: op.operatorProfitFinalAmount !== null ? Number(op.operatorProfitFinalAmount) : null,
        operatorProfitFinalCurrencyCode: op.operatorProfitFinalCurrencyCode || null,
